...
export const AudioSettingsProvider: React.FC<{ children: ReactNode }> = ({
  children,
}) => {
  ...
  const sounds = useRef<Record<string, Sound>>({
    ...
    marching: {
      audio: new Audio("/music/marchingShort.mp3"),
      identifier: "marching",
    },
    sword: { audio: new Audio("/music/sword.mp3"), identifier: "sword" },
    backgroundMusic: {
      audio: new Audio("/music/lords_sounds.mp3"),
      identifier: "backgroundMusic",
    },
  });
