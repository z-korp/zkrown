...
const ActionLogs: React.FC = () => {
  ...
  const { setHighlightedRegion, setBattleReport, battleReport } =
  ...
  return (
    <div className="max-w-xl w-full border-2 rounded-lg bg-stone-700 border-stone-900 text-white font-vt323">
      <div
      ...
      <animated.div
        style={springProps}
        ref={logsRef}
        className="max-h-48 overflow-x-auto scrollbar-custom"
      >
        {logs.length !== 0 && (
