    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-50 font-vt323">
      <div className="relative bg-stone-700 border-2 border-stone-900 p-6 rounded-lg shadow-lg text-center pointer-events-auto">
        ...
        <div className="max-w-xl text-white mb-4 mx-auto">
          ...
          <p>
            Combine any three cards to receive supplies - merge three identical
            cards, or three different ones. Choose wisely to strengthen your
            realm!
          </p>
        </div>
      ...
      <ToastProvider>
        {isHovered && (
          <ToastViewport>
            <Toast>
              <img
                src={imgCardExplanation}
                alt="Transfert card to win troops"
              />
              <ToastClose />
            </Toast>
          </ToastViewport>
