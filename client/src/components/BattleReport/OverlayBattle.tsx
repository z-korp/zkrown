...
const OverlayBattle: React.FC<{ onClose: () => void; battle: Battle }> = ({
  onClose,
  battle,
}) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex flex-col p-4 bg-stone-700 border-stone-900 rounded-lg shadow-lg"
        ...
        {currentRound < battle.rounds.length && (
          <div className="flex mt-4 gap-4 self-end">
            ...
            <Button
              ...
              onClick={() => setCurrentRound(battle.rounds.length)}
            >
              Skip to Result
              <SkipForward size={15} />
            </Button>
