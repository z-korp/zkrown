...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("text-white [&>tr]:first:border-0", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    className={cn(
      "overflow-hidden text-white rounded-lg w-full border border-stone-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "bg-stone-600 p-4 align-middle [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
