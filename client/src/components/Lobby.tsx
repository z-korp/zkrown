  ...
  const startGame = async () => {
    if (game_id === undefined) {
      ...
      toast({
        variant: "destructive",
        description: (
          <code className="text-white text-xs">{"Game id not defined"}</code>
        ),
      });
      return;
    }
        ...
        <div className="w-5/6 max-w-4xl flex flex-col bg-stone-500 p-8 rounded-lg">
          <div className="flex items-center w-full relative justify-center">
            ...
            <div className="flex-grow h-fit">
              <p className="text-white absolute text-xl right-0 top-2">
                    ...
                    <TableCell>
                      {
                        <div className="flex gap-8 items-center justify-between">
                          ...
                          <div className="flex gap-6">
                            {isHost(game.host, me.address) &&
                              player.address !== me.address && (
                                <>
                                  <Button
