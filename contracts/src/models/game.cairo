...
use zkrown::models::player::{Player, PlayerTrait};
use zkrown::models::index::Game;
...
impl GameImpl of GameTrait {
    #[inline(always)]
    fn new(id: u32, host: felt252, price: u256, penalty: u64, config: Config) -> Game {
        // [Check] Host is valid
...
mod tests {
    ...
    use super::{
        Game, GameTrait, Turn, ZeroableGame, Config, TURN_COUNT, MAXIMUM_PLAYER_COUNT,
    ...
    fn test_game_new() {
        let game = GameTrait::new(ID, HOST, PRICE, PENALTY, Config::Test);
    ...
    #[available_gas(100_000)]
    fn test_game_join() {
        let mut game = GameTrait::new(ID, HOST, PRICE, PENALTY, Config::Test);
        game.join();
        let index = game.join();
